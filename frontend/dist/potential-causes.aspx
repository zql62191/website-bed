...
<html lang="en" xmlns:ng="http://angularjs.org" id="ng-app" ng-app="cdmp" ng-controller="MainController" class="in-dev">
  <head>
    ...
    <link rel="stylesheet" href="/hcp/me/mediaelementplayer.min.css?1438296576090"/>
    <link rel="stylesheet" href="/hcp/css/styles.css?1438296576090"/>
    <script src="//fast.fonts.net/jsapi/632e2bdc-4739-4b24-904b-c0e880eac200.js"></script>
    <script src="js/inline/cloak.js?__inline=true"></script>
    <script src="js/inline/iev.js?__inline=true"></script>
    <script src="/hcp/js/head.js?1438296576090"></script>
  </head>
  <body ontouchstart="" prime-directive="" class="potential-causes">
    <main class="content--main">
      ...
      <section class="section--theories">
        <div class="wrap--content">
          ...
          <h1 class="heading--1">
            Research suggests B.E.D. may have a neurobiological basis with genetic and environmental risk factors
            
          </h1>
          <h2 class="heading--2">
            These prevailing theories may support a neurobiological basis for <abbr title="Binge Eating Disorder">B.E.D.</abbr>
            
          </h2>
          <div class="row brain">
            <div class="icon is--vc"></div>
            <h4 class="heading--4">Reward center and impulsivity dysregulation theory</h4>
            <p>Adults with <abbr title="Binge Eating Disorder">B.E.D.</abbr> have shown reduced activity in impulse control&ndash;related regions of the brain<sup>1-4</sup>
    ...
    <script src="/hcp/js/vendor.js?1438296576093"></script>
    <script src="/hcp/js/templates.js?1438296576093"></script>
    <script src="/hcp/js/app.js?1438296576093"></script>
