...
<html lang="en" xmlns:ng="http://angularjs.org" id="ng-app" ng-app="cdmp" ng-controller="MainController" class="in-dev">
  <head>
    ...
    <link rel="stylesheet" href="/hcp/css/styles.css?1438292786850"/>
    <script src="//fast.fonts.net/jsapi/632e2bdc-4739-4b24-904b-c0e880eac200.js"></script>
    <script src="js/inline/cloak.js?__inline=true"></script>
    <script src="js/inline/iev.js?__inline=true"></script>
    <script src="/hcp/js/head.js?1438292786851"></script>
  </head>
  <body ontouchstart="" prime-directive="" class="recognizing-bed">
    ...
    <script src="/hcp/js/vendor.js?1438292786857"></script>
    <script src="/hcp/js/templates.js?1438292786857"></script>
    <script src="/hcp/js/app.js?1438292786857"></script>
