...
<html lang="en" xmlns:ng="http://angularjs.org" id="ng-app" ng-app="cdmp" ng-controller="MainController" class="in-dev">
  <head>
    ...
    <link rel="stylesheet" href="/hcp/css/styles.css?1438203307449"/>
    <script src="//fast.fonts.net/jsapi/632e2bdc-4739-4b24-904b-c0e880eac200.js"></script>
    <script src="js/inline/cloak.js?__inline=true"></script>
    <script src="js/inline/iev.js?__inline=true"></script>
    <script src="/hcp/js/head.js?1438203307449"></script>
  </head>
  <body ontouchstart="" prime-directive="" class="effects-of-bed">
    <main class="content--main">
      ...
      <section class="section--association">
        <div class="wrap--content">
          ...
          <p data-note="*" class="footnote">Data are from an eating disorder–assessed subsample (n=2,980) of the National Comorbidity Survey Replication, a nationally representative face-to-face household survey of English-speaking adults aged ≥18 years.<sup>2</sup>
    ...
    <script src="/hcp/js/vendor.js?1438203307451"></script>
    <script src="/hcp/js/templates.js?1438203307451"></script>
    <script src="/hcp/js/app.js?1438203307451"></script>
