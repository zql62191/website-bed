...
<html lang="en" xmlns:ng="http://angularjs.org" id="ng-app" ng-app="cdmp" ng-controller="MainController" class="in-dev">
  <head>
    ...
    <link rel="stylesheet" href="/hcp/me/mediaelementplayer.min.css?1438296575589"/>
    <link rel="stylesheet" href="/hcp/css/styles.css?1438296575589"/>
    <script src="//fast.fonts.net/jsapi/632e2bdc-4739-4b24-904b-c0e880eac200.js"></script>
    <script src="js/inline/cloak.js?__inline=true"></script>
    <script src="js/inline/iev.js?__inline=true"></script>
    <script src="/hcp/js/head.js?1438296575589"></script>
  </head>
  <body ontouchstart="" prime-directive="" class="effects-of-bed">
    <main class="content--main">
          ...
          <div class="wrap--content">
            <nav>
              <ul>
                ...
                <li><a href="/hcp/effects-of-BED.aspx" class="active">Potential Effects</a>
                </li>
      ...
      <section class="section--associated">
        <div class="wrap--content">
          <h1 class="heading--1">Binge eating disorder (<abbr title="Binge Eating Disorder">B.E.D.</abbr>) is associated with a range of functional consequences<sup>1</sup></h1>
        ...
        <div class="wrap--content">
          ...
          <div class="charts">
            <div class="chart sixty-three">
              ...
              <div class="text">reported severe<br>impairment during the<br>past year</div>
            </div>
            <div class="chart nineteen">
              <div class="num">&asymp;19%</div>
              <div class="text">reported <em>severe</em> functional<br>impairment during the<br>past year</div>
            </div>
          </div>
          <h2 class="heading--2">
            The Sheehan Disability Scales were administered to assess the severity of recent episodes of disordered eating.
            
          </h2>
          <p data-note="*" class="footnote">Data are from an eating disorder&ndash;assessed subsample (n=2,980) of the National Comorbidity Survey Replication, a nationally representative face-to-face household survey of English-speaking adults aged &ge;18 years.<sup>2</sup>
      ...
      <section class="section--living">
        <div class="wrap--content">
          ...
          <div class="sunny hide--lg hide--md"></div>
          ...
          <div class="sunny hide--lg hide--sm"></div>
    ...
    <script src="/hcp/js/vendor.js?1438296575592"></script>
    <script src="/hcp/js/templates.js?1438296575592"></script>
    <script src="/hcp/js/app.js?1438296575592"></script>
