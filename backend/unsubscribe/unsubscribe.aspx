...
<html lang="en" xmlns:ng="http://angularjs.org" id="ng-app" ng-app="cdmp" ng-controller="MainController">
  <head>
    ...
    <link rel="stylesheet" href="./css/styles.css?1439574300000"/>
    <script src="//fast.fonts.net/jsapi/632e2bdc-4739-4b24-904b-c0e880eac200.js"></script>
    <script src="js/inline/cloak.js?__inline=true"></script>
    <script src="js/inline/iev.js?__inline=true"></script>
    <script src="./js/head.js?1439574300000"></script>
    <script src="./js/redirect.js?1439574300000"></script>
<script>
    pageLoading();
</script>
  ...
  <body ontouchstart="" prime-directive="" class="unsubscribe">
                ...
                <div class="accordion__content">
                  <div ng-controller="emailController" class="formContainer">
                    <form name="optOutEmail" autocomplete="off" novalidate show-errors="{showSuccess:true}" ng-submit="submitForm()" class="emailForm">
                      <input type="email" name="email" placeholder="E-mail" ng-model="user.email" required ng-class="{forminvalid: (optOutEmail.email.$invalid &amp;&amp; optOutEmail.email.$dirty &amp;&amp; submitted) || (optOutEmail.email.$invalid &amp;&amp; optOutEmail.email.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)" class="form-control">
                ...
                <div class="accordion__content">
                  <div ng-controller="directmailController" class="formContainer">
                    <form name="optoutdirectmail" autocomplete="off" novalidate show-errors="{showSuccess:true}" ng-submit="submitForm()" class="directMail form-group">
                      <input type="email" name="email" placeholder="E-mail" ng-model="user.email" required ng-class="{forminvalid: (optoutdirectmail.email.$invalid &amp;&amp; optoutdirectmail.email.$dirty &amp;&amp; submitted) || (optoutdirectmail.email.$invalid &amp;&amp; optoutdirectmail.email.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)" class="form-control">
                      ...
                      <input type="text" name="firstName" placeholder="First Name" ng-model="firstName" ng-required="true" ng-class="{forminvalid: (optoutdirectmail.firstName.$invalid &amp;&amp; optoutdirectmail.firstName.$dirty &amp;&amp; submitted) || (optoutdirectmail.firstName.$invalid &amp;&amp; optoutdirectmail.firstName.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <p ng-if="submitted &amp;&amp; optoutdirectmail.firstName.$error.required" class="help-block"></p>
                      <input type="text" name="lastName" placeholder="Last Name" ng-model="lastname" ng-required="true" ng-class="{forminvalid: (optoutdirectmail.lastName.$invalid &amp;&amp; optoutdirectmail.firstName.$dirty &amp;&amp; submitted) || (optoutdirectmail.lastName.$invalid &amp;&amp; optoutdirectmail.lastName.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <p ng-if="submitted &amp;&amp; optoutdirectmail.lastName.$error.required" class="help-block"></p>
                      <input type="text" name="address" placeholder="Street Address" ng-model="address" ng-required="true" ng-class="{forminvalid: (optoutdirectmail.address.$invalid &amp;&amp; optoutdirectmail.address.$dirty &amp;&amp; submitted) || (optoutdirectmail.address.$invalid &amp;&amp; optoutdirectmail.address.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <p ng-if="submitted &amp;&amp; optoutdirectmail.address.$error.required" class="help-block"></p>
                      <input type="text" name="suite" placeholder="Suite/Office (not required)" ng-model="suite" ng-required="false" ng-class="{forminvalid: (optoutdirectmail.suite.$invalid &amp;&amp; optoutdirectmail.suite.$dirty &amp;&amp; submitted) || (optoutdirectmail.suite.$invalid &amp;&amp; invalidform &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <input type="text" name="city" placeholder="City" ng-model="city" ng-required="true" ng-class="{forminvalid: (optoutdirectmail.city.$invalid &amp;&amp; optoutdirectmail.city.$dirty &amp;&amp; submitted) || (optoutdirectmail.city.$invalid &amp;&amp; optoutdirectmail.city.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <p ng-if="submitted &amp;&amp; optoutdirectmail.city.$error.required" class="help-block"></p>
                      <select type="text" name="state" placeholder="State" ng-model="state" ng-required="true" ng-class="{forminvalid: (optoutdirectmail.state.$invalid &amp;&amp; optoutdirectmail.state.$dirty &amp;&amp; submitted) || (optoutdirectmail.state.$invalid &amp;&amp; optoutdirectmail.state.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      ...
                      <input type="text" name="zip" placeholder="Zip" ng-model="zip" ng-required="true" ng-class="{forminvalid: (optoutdirectmail.$invalid &amp;&amp; optoutdirectmail.zip.$dirty &amp;&amp; submitted) || (optoutdirectmail.zip.$invalid &amp;&amp; optoutdirectmail.zip.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                ...
                <div class="accordion__content">
                  <div ng-controller="allmailController" class="formContainer">
                    <form name="optinall" autocomplete="off" novalidate show-errors="{showSuccess:true}" ng-submit="submitForm()" class="form-group">
                      <input type="email" name="email" placeholder="E-mail" ng-model="user.email" required ng-class="{forminvalid: (optinall.email.$invalid &amp;&amp; optinall.email.$dirty &amp;&amp; submitted) || (optinall.email.$invalid &amp;&amp; optinall.email.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)" class="form-control">
                      ...
                      <input type="text" name="firstName" placeholder="First Name" ng-model="firstName" ng-required="true" ng-class="{forminvalid: (optinall.firstName.$invalid &amp;&amp; optinall.firstName.$dirty &amp;&amp; submitted) || (optinall.firstName.$invalid &amp;&amp; optinall.firstName.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <p ng-if="submitted &amp;&amp; optinall.firstName.$error.required" class="help-block"></p>
                      <input type="text" name="lastName" placeholder="Last Name" ng-model="lastname" ng-required="true" ng-class="{forminvalid: (optinall.lastName.$invalid &amp;&amp; optinall.firstName.$dirty &amp;&amp; submitted) || (optinall.lastName.$invalid &amp;&amp; optinall.lastName.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <p ng-if="submitted &amp;&amp; optinall.lastName.$error.required" class="help-block"></p>
                      <input type="text" name="address" placeholder="Street Address" ng-model="address" ng-required="true" ng-class="{forminvalid: (optinall.address.$invalid &amp;&amp; optinall.address.$dirty &amp;&amp; submitted) || (optinall.address.$invalid &amp;&amp; optinall.addresss.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <p ng-if="submitted &amp;&amp; optinall.address.$error.required" class="help-block"></p>
                      <input type="text" name="suite" placeholder="Suite/Office (not required)" ng-model="suite" ng-required="false" ng-class="{forminvalid: (optinall.suite.$invalid &amp;&amp; optinall.suite.$dirty &amp;&amp; submitted) || (optinall.suite.$invalid &amp;&amp; invalidform &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <input type="text" name="city" placeholder="City" ng-model="city" ng-required="true" ng-class="{forminvalid: (optinall.city.$invalid &amp;&amp; optinall.city.$dirty &amp;&amp; submitted) || (optinall.city.$invalid &amp;&amp; optinall.city.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                      <div ng-if="submitted &amp;&amp; optinall.city.$error.required" class="help-block"></div>
                      <select type="text" name="state" placeholder="State" ng-model="state" ng-required="true" ng-class="{forminvalid: (optinall.state.$invalid &amp;&amp; optinall.state.$dirty &amp;&amp; submitted) || (optinall.state.$invalid &amp;&amp; optinall.state.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
                              <option value="">State</option>
                              <option value="AL">AL</option>
                              <option value="AK">AK</option>
                              <option value="AZ">AZ</option>
                      ...
                      <input type="text" name="zip" placeholder="Zip" ng-model="zip" ng-required="true" ng-class="{forminvalid: (optinall.zip.$invalid &amp;&amp; optinall.zip.$dirty &amp;&amp; submitted) || (optinall.zip.$invalid &amp;&amp; optinall.zip.$pristine &amp;&amp; submitted)}" ng-blur="syncFields($event)">
    ...
    <script src="./js/vendor.js?1439574300000"></script>
    <script src="./js/templates.js?1439574300000"></script>
    <script src="./js/app.js?1439574300000"></script>
