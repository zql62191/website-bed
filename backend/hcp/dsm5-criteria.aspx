<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dsm5-criteria.aspx.cs" Inherits="dsm5criteria" %><!DOCTYPE html>
<html lang="en" xmlns:ng="http://angularjs.org" id="ng-app" ng-app="cdmp" ng-controller="MainController">
  <head>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta charset="utf-8">
    <title>DSM-5 Criteria for Binge Eating Disorder</title>
  ...
  <body ontouchstart="" prime-directive="" class="dsm5-criteria">
    <main class="content--main">
          ...
          <div class="wrap--content">
            <nav>
              <ul>
                ...
                <li><a href="/hcp/dsm5-criteria.aspx" class="active"><em>DSM-5</em><sup>&reg;</sup> Criteria</a>
                </li>
      ...
      <section class="section--individuals">
        <div class="wrap--content">
          <h1 class="heading--1 yellow">Diagnosing adults with binge eating disorder (B.E.D.) <br class="hide--sm">
            
          </h1>
          <h2 class="heading--2">Individuals with B.E.D. <br class="hide--sm">must meet all of the following <br class="desktop-break"> 
            <span class="roman">DSM-5<sup>&reg;</sup></span> diagnostic criteria<sup>1</sup>:
          ...
          <p class="disclaimer">Diagnosis should be based upon a complete evaluation of the patient that confirms the criteria for B.E.D. established in 
            <nobr><em>DSM-5</em><sup>&reg;</sup>.<sup>1</sup></nobr>
            
            
          </p>
          <div class="trim center"><a href="/hcp/sign-up.aspx" class="btn btn--yellow">GET THE FULL <em><em>DSM-5</em><sup>&reg;</sup></em> B.E.D. <br class="mobile-break">DIAGNOSTIC CRITERIA</a></div>
          <div class="wrap--refs">
