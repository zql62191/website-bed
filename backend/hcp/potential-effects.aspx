  ...
  <body ontouchstart="" prime-directive="" class="potential-effects">
    <main class="content--main">
      ...
      <section class="section--button">
        <div class="wrap--content">
          <div class="center"><a href="sign-up.aspx" class="btn btn--yellow">GET THE FULL <abbr title="Fifth Edition of the Diagnostic and Statistical Manual of Mental Disorders"><em>DSM-5</em><sup>&reg;</sup></abbr> <br class="mobile-break"><abbr title="Binge Eating Disorder">B.E.D.</abbr> CRITERIA</a></div>
        </div>
        <div class="wrap--refs">
