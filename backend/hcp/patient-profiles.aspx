  ...
  <body ontouchstart="" prime-directive="" class="patient-profiles">
    <main class="content--main">
      ...
      <section class="section--patients">
        <div class="wrap--content">
          <h1 class="heading--1">
            How adult patients with binge eating disorder (B.E.D.) may present&mdash;and tools to help when they do
          ...
          <div class="callouts">
            <div class="callout one">
              ...
              <p>Use this validated screener to help evaluate adult <br class="desktop-break">patients you suspect may have B.E.D.</p><a href="media/BingeEatingDisorder_Screener.pdf" target="_blank" class="btn btn--yellow authorized-link">DOWNLOAD THE ADULT <br class="mobile-break">B.E.D. PATIENT SCREENER</a>
            </div>
            <div class="callout two">
              <h2 class="heading--2 bold">Conducting a conversation</h2>
              <p>Use this discussion guide to help begin a dialogue <br class="desktop-break">about B.E.D. with your adult patients.</p><a href="media/BingeEatingDisorderDiscussionGuide.pdf" target="_blank" class="btn btn--yellow authorized-link">DOWNLOAD THE DISCUSSION GUIDE FOR ADULT PATIENTS WITH B.E.D.</a>
            </div>
          </div>
