...
<script>
  ...
  <body ontouchstart="" prime-directive="" class="sign-up">
    <main class="content--main">
      <header class="header--global">
        <div class="title-bar">
          <div class="wrap--content"><a href="/hcp/index.aspx" class="title">
            ...
            <div class="hcp">Not a US health care professional? Please visit <a href="http://www.bingeeatingdisorder.com/" target="_blank" class="authorized-link">patient site.</a></div><a href="/hcp/sign-up.aspx" class="signup hide--md hide--sm active">Get the full <em>DSM-5</em><sup>&reg;</sup> B.E.D. criteria</a>
          ...
          <div class="wrap--content">
            <nav>
              <ul>
                ...
                <li class="hide--lg"><a href="/hcp/sign-up.aspx" class="mobilesignup active">Get the full <em>DSM-5</em><sup>&reg;</sup> <br>B.E.D. criteria</a>
                </li>
              </ul>
            </nav>
          </div>
      ...
      <header class="header--page SignUpheader">
        <div class="wrap--content">
          <h1 class="heading--1">Sign up to instantly receive the <em>DSM-5</em><sup>&reg;</sup> diagnostic criteria for binge eating disorder (B.E.D.) and future B.E.D. content from Shire.</h1>
        </div>
      </header>
      <section ng-controller="signupController" class="section--page">
        <div class="wrap--content">
          <form name="optInForm" autocomplete="off" novalidate show-errors="{showSuccess:true}" ng-submit="submitForm(); optForm()" class="form-group">
            ...
            <div class="info">
              <p ng-if="submitted &amp;&amp; (optInForm.checkBox.$error.required)" class="help-block">Please select the checkbox</p>
              <input type="checkBox" id="optInCheck" name="checkBox" ng-model="checkBox" required>
