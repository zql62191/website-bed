                ...
                <div class="accordion__content">
                  <div ng-controller="emailController" class="formContainer">
                    <form name="optOutEmail" autocomplete="off" novalidate show-errors="{showSuccess:true}" ng-submit="submitForm()" class="emailForm">
                      <input type="email" name="email" placeholder="E-mail" ng-model="user.email" required ng-class="{forminvalid: (optOutEmail.email.$invalid &amp;&amp; optOutEmail.email.$dirty &amp;&amp; submitted) || (optOutEmail.email.$invalid &amp;&amp; optOutEmail.email.$pristine &amp;&amp; submitted)}" class="form-control">
                      <p ng-if="submitted &amp;&amp; (optOutEmail.email.$error.email || optOutEmail.email.$error.required)" class="help-block">Please enter e-mail address</p>
                ...
                <div class="accordion__content">
                  <div ng-controller="directmailController" class="formContainer">
                    <form name="optoutdirectmail" autocomplete="off" novalidate show-errors="{showSuccess:true}" ng-submit="submitForm()" class="directMail form-group">
                      <input type="email" name="email" placeholder="E-mail" ng-model="user.email" required ng-class="{forminvalid: (directmailController.email.$invalid &amp;&amp; directmailController.email.$dirty &amp;&amp; submitted) || (directmailController.email.$invalid &amp;&amp; directmailController.email.$pristine &amp;&amp; submitted)}" class="form-control">
                      ...
                      <input type="text" name="firstName" placeholder="First Name" ng-model="firstName" ng-required="true" ng-class="{forminvalid: (directmailController.firstName.$invalid &amp;&amp; directmailController.firstName.$dirty &amp;&amp; submitted) || (directmailController.firstName.$invalid &amp;&amp; directmailController.firstName.$pristine &amp;&amp; submitted)}">
                      <p ng-if="submitted &amp;&amp; optoutdirectmail.firstName.$error.required" class="help-block">The user's first name is required</p>
                      <input type="text" name="lastName" placeholder="Last Name" ng-model="lastname" ng-required="true" ng-class="{forminvalid: (directmailController.lastName.$invalid &amp;&amp; directmailController.firstName.$dirty &amp;&amp; submitted) || (directmailController.lastName.$invalid &amp;&amp; directmailController.lastName.$pristine &amp;&amp; submitted)}">
                      <p ng-if="submitted &amp;&amp; optoutdirectmail.lastName.$error.required" class="help-block">The user's last name is required</p>
                      <input type="text" name="address" placeholder="Street Address" ng-model="address" ng-required="true" ng-class="{forminvalid: (directmailController.address.$invalid &amp;&amp; directmailController.address.$dirty &amp;&amp; submitted) || (directmailController.address.$invalid &amp;&amp; directmailController.address.$pristine &amp;&amp; submitted)}">
                      <p ng-if="submitted &amp;&amp; optoutdirectmail.address.$error.required" class="help-block">The user's street address is required</p>
                      <input type="text" name="suite" placeholder="Suite/Office (not required)" ng-model="suite" ng-required="false" ng-class="{forminvalid: (directmailController.suite.$invalid &amp;&amp; directmailController.suite.$dirty &amp;&amp; submitted) || (directmailController.suite.$invalid &amp;&amp; invalidform &amp;&amp; submitted)}">
                      <input type="text" name="city" placeholder="City" ng-model="city" ng-required="true" ng-class="{forminvalid: (directmailController.city.$invalid &amp;&amp; directmailController.city.$dirty &amp;&amp; submitted) || (directmailController.city.$invalid &amp;&amp; directmailController.city.$pristine &amp;&amp; submitted)}">
                      <p ng-if="submitted &amp;&amp; optoutdirectmail.city.$error.required" class="help-block">The user's city is required</p>
                      <select type="text" name="state" placeholder="State" ng-model="state" ng-required="true" ng-class="{forminvalid: (directmailController.state.$invalid &amp;&amp; directmailController.state.$dirty &amp;&amp; submitted) || (directmailController.state.$invalid &amp;&amp; directmailController.state.$pristine &amp;&amp; submitted)}">
                      ...
                      <input type="text" name="zip" placeholder="Zip" ng-model="zip" ng-required="true" ng-class="{forminvalid: (directmailController.$invalid &amp;&amp; directmailController.zip.$dirty &amp;&amp; submitted) || (directmailController.zip.$invalid &amp;&amp; directmailController.zip.$pristine &amp;&amp; submitted)}">
                      <p ng-if="submitted &amp;&amp; optoutdirectmail.zip.$error.required" class="help-block">The user's zip code is required</p>
                      <button type="submit" ng-click="submitForm()" class="btn btn--yellow">SUBMIT</button>
                    </form>
                  </div>
                </div>
              </div>
                ...
                <div class="accordion__content">
                  <div ng-controller="allmailController" class="formContainer">
                    <form name="optinall" autocomplete="off" novalidate show-errors="{showSuccess:true}" ng-submit="submitForm()" class="form-group">
                      <input type="email" name="email" placeholder="E-mail" ng-model="user.email" required ng-class="{forminvalid: (optinall.email.$invalid &amp;&amp; optinall.email.$dirty &amp;&amp; submitted) || (optinall.email.$invalid &amp;&amp; optinall.email.$pristine &amp;&amp; submitted)}" class="form-control">
                      ...
                      <input type="text" name="firstName" placeholder="First Name" ng-model="firstName" ng-required="true" ng-class="{forminvalid: (optinall.firstName.$invalid &amp;&amp; optinall.firstName.$dirty &amp;&amp; submitted) || (optinall.firstName.$invalid &amp;&amp; optinall.firstName.$pristine &amp;&amp; submitted)}">
                      <p ng-if="submitted &amp;&amp; optinall.firstName.$error.required" class="help-block">The user's first name is required</p>
                      <input type="text" name="lastName" placeholder="Last Name" ng-model="lastname" ng-required="true" ng-class="{forminvalid: (optinall.lastName.$invalid &amp;&amp; optinall.firstName.$dirty &amp;&amp; submitted) || (optinall.lastName.$invalid &amp;&amp; optinall.lastName.$pristine &amp;&amp; submitted)}">
                      <p ng-if="submitted &amp;&amp; optinall.lastName.$error.required" class="help-block">The user's last name is required</p>
                      <input type="text" name="address" placeholder="Street Address" ng-model="address" ng-required="true" ng-class="{forminvalid: (optinall.address.$invalid &amp;&amp; optinall.address.$dirty &amp;&amp; submitted) || (optinall.address.$invalid &amp;&amp; optinall.addresss.$pristine &amp;&amp; submitted)}">
                      <p ng-if="submitted &amp;&amp; optinall.address.$error.required" class="help-block">The user's street address is required</p>
                      <input type="text" name="suite" placeholder="Suite/Office (not required)" ng-model="suite" ng-required="false" ng-class="{forminvalid: (optinall.suite.$invalid &amp;&amp; optinall.suite.$dirty &amp;&amp; submitted) || (optinall.suite.$invalid &amp;&amp; invalidform &amp;&amp; submitted)}">
                      <input type="text" name="city" placeholder="City" ng-model="city" ng-required="true" ng-class="{forminvalid: (optinall.city.$invalid &amp;&amp; optinall.city.$dirty &amp;&amp; submitted) || (optinall.city.$invalid &amp;&amp; optinall.city.$pristine &amp;&amp; submitted)}">
                      <div ng-if="submitted &amp;&amp; optinall.city.$error.required" class="help-block">The user's city is required</div>
                      <select type="text" name="state" placeholder="State" ng-model="state" ng-required="true" ng-class="{forminvalid: (optinall.state.$invalid &amp;&amp; optinall.state.$dirty &amp;&amp; submitted) || (optinall.state.$invalid &amp;&amp; optinall.state.$pristine &amp;&amp; submitted)}">
                              <option value="">State</option>
                              <option value="AL">AL</option>
                              <option value="AK">AK</option>
                              <option value="AZ">AZ</option>
                      ...
                      <input type="text" name="zip" placeholder="Zip" ng-model="zip" ng-required="true" ng-class="{forminvalid: (optinall.zip.$invalid &amp;&amp; optinall.zip.$dirty &amp;&amp; submitted) || (optinall.zip.$invalid &amp;&amp; optinall.zip.$pristine &amp;&amp; submitted)}">
                      <p ng-if="submitted &amp;&amp; optinall.zip.$error.required" class="help-block">The user's zip code is required</p>
                      <button type="submit" ng-click="submitForm()" class="btn btn--yellow">SUBMIT</button>
                    </form>
                  </div>
                </div>
