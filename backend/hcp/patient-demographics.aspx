<%@ Page Language="C#" AutoEventWireup="true" CodeFile="patient-demographics.aspx.cs" Inherits="patientdemographics" %><!DOCTYPE html>
...
<script>
  ...
  <body ontouchstart="" prime-directive="" class="patient-demographics">
    <main class="content--main">
          ...
          <div class="wrap--content">
            <nav>
              <ul>
                ...
                <li><a href="/hcp/patient-demographics.aspx" class="active">Patient Demographics</a>
                </li>
      ...
      <section class="section--survey">
        <div class="wrap--content">
          ...
          <h2 class="heading--2">of the 344 who met <span class="roman">DSM-5<sup>&reg;</sup> </span> diagnostic criteria for <abbr title="Binge Eating Disorder">B.E.D.</abbr> in the past 12 months (level of severity not specified):</h2>
      ...
      <section class="section--ratio">
        <div class="wrap--content">
          ...
          <div class="row five-to-one">
            <div class="center">
              <h2 class="heading--2">
                <div class="estimated"><em class="ratio">5:1</em> Estimated 12-month <br class="hide--lg hide--md">prevalence of <span class="yellow">bulimia nervosa</span> in US adults<sup>&sect;</sup>:</div>
                <div class="versus"><span class="percent">0.5%</span> &nbsp;of women <span class="vs">&nbsp;vs&nbsp;</span> <span class="percent">0.1%</span> &nbsp;of men</div>
              </h2>
            </div>
          </div>
          <p data-note-sup="" class="footnote"><sup>&sect;</sup>Data from an eating disorder&ndash;assessed subsample (n=2,980) of the National Comorbidity Survey Replication, a <br>nationally representative face-to-face household survey of English-speaking adults aged &ge;18 years.<sup>1</sup></p>
        </div>
      </section>
      <section class="section--onset">
        <div class="wrap--content">
          ...
          <p data-note-sup="" class="footnote"><sup>||</sup>Data from an eating disorder&ndash;assessed subsample (n=2,980) of the National Comorbidity Survey Replication, a <br>nationally representative face-to-face household survey of English-speaking adults aged &ge;18 years.<sup>1</sup>
      ...
      <section class="section--groups">
        ...
        <div class="wrap--refs">
          <ol class="refs number">
            ...
            <li>Kessler RC, Berglund PA, Chiu WT, et al. <em>Biol Psychiatry. </em>2013;73(9):904-914.</li>
            ...
            <li>Marques L, Alegria M, Becker AE, et al. <em>Int J Eat Disord</em>. 2011;44(5):412-420.</li>
          </ol>
        </div>
      </section>
