...
<html lang="en" xmlns:ng="http://angularjs.org" id="ng-app" ng-app="cdmp" ng-controller="MainController" class="in-dev">
  <head>
    ...
    <link rel="stylesheet" href="/hcp/css/styles.css?1437594960519"/>
    <script src="//fast.fonts.net/jsapi/632e2bdc-4739-4b24-904b-c0e880eac200.js"></script>
    <script src="js/inline/cloak.js?__inline=true"></script>
    <script src="js/inline/iev.js?__inline=true"></script>
    <script src="/hcp/js/head.js?1437594960519"></script>
  </head>
  <body ontouchstart="" prime-directive="" class="profiles">
        ...
        <div class="wrap--content">
          ...
          <div class="callouts">
            <div class="callout one">
              ...
              <p>Use this validated screener to help evaluate adult patients you suspect may have <abbr title="Binge Eating Disorder">B.E.D.</abbr></p><a href="#needurl" class="btn btn--blue">DOWNLOAD THE <abbr title="Binge Eating Disorder">B.E.D.</abbr> SCREENER</a>
            </div>
    ...
    <script src="/hcp/js/vendor.js?1437594960520"></script>
    <script src="/hcp/js/templates.js?1437594960520"></script>
    <script src="/hcp/js/app.js?1437594960520"></script>
