<%@ Page Language="C#" AutoEventWireup="true" CodeFile="potential-causes.aspx.cs" Inherits="potential_causes" %>
...
<html lang="en" xmlns:ng="http://angularjs.org" id="ng-app" ng-app="cdmp" ng-controller="MainController" class="in-dev">
  <head>
    ...
    <link rel="stylesheet" href="/hcp/css/styles.css?1437594960395"/>
    <script src="//fast.fonts.net/jsapi/632e2bdc-4739-4b24-904b-c0e880eac200.js"></script>
    <script src="js/inline/cloak.js?__inline=true"></script>
    <script src="js/inline/iev.js?__inline=true"></script>
    <script src="/hcp/js/head.js?1437594960396"></script>
  </head>
  <body ontouchstart="" prime-directive="" class="potential-causes">
    <main class="content--main">
      ...
      <section class="section--theories">
        <div class="wrap--content">
          <h2 class="heading--2">
            The exact cause of binge eating disorder (<abbr title="Binge Eating Disorder">B.E.D.</abbr>) is unknown
            
          </h2>
          <h1 class="heading--1">
            Prevailing theories may support a neurobiological basis for <abbr title="Binge Eating Disorder">B.E.D.</abbr>
            
          </h1>
          <div class="row brain">
            <div class="icon is--vc"></div>
            <h4 class="heading--4">Reward center and impulsivity dysregulation theory</h4>
            <p>Adults with <abbr title="Binge Eating Disorder">B.E.D.</abbr> have shown reduced activity in impulse control–related regions of the brain<sup>1-4</sup>
          ...
          <div class="row neuron-closeup">
            <div class="icon is--vc"></div>
            <h4 class="heading--4">Endogenous μ-opioid signaling dysfunction theory</h4>
            <p>Opioid signaling converts sensory stimuli into processes that generate or enhance “liking” of a particular food<sup>8-11</sup>
      ...
      <section class="section--factors">
        <div class="wrap--content">
          <h1 class="heading--1">
            Research suggests these possible risk factors for <abbr title="Binge Eating Disorder">B.E.D.</abbr>
          ...
          <div class="row dna">
            ...
            <ul class="square">
              <li><abbr title="Binge Eating Disorder">B.E.D.</abbr> appears to run in families, which may reflect additive genetic influences<sup>12</sup></li>
              <li>Genetic differences in neurobiological components of the brain’s reward center have been observed<sup>8,13</sup></li>
            </ul>
          </div>
        ...
        <div class="wrap--refs">
          <ol class="refs number">
            <li>Balodis IM, Molina ND, Kober H, et al. Obesity (Silver Spring). 2013;21(2):367-377.</li>
            <li>Schäfer A, Vaitl D, Schienle A. Neuroimage. 2010;50(2):639-643.</li>
            <li>Woolley JD, Gorno-Tempini ML, Seeley WW, et al. Neurology. 2007;69(14):1424-1433.</li>
            <li>Schienle A, Schäfer A, Hermann A, Vaitl D. Biol Psychiatry. 2009;65(8):654-661.</li>
            <li>Davis C, Levitan RD, Yilmaz Z, Kaplan AS, Carter JC, Kennedy JL. Prog Neuropsychopharmacol Biol Psychiatry. 2012;38(2):328-335.</li>
            <li>Wang GJ, Geliebter A, Volkow ND, et al. Obesity (Silver Spring). 2011;19(8):1601-1608.</li>
            <li>Levitan RD, Masellis M, Basile VS, et al. Biol Psychiatry. 2004;56(9):665-669.</li>
            <li>Davis CA, Levitan RD, Reid C, et al. Obesity (Silver Spring). 2009;17(6):1220-1225.</li>
            <li>Naleid AM, Grace MK, Chimukangara M, Billington CJ, Levine AS. Am J Physiol Regul Integr Comp Physiol. 2007;293(1):R99-R105.</li>
            <li>Boggiano MM, Chandler PC, Viana JB, Oswald KD, Maldonado CR, Wauford PK. Behav Neurosci. 2005;119(5):1207-1214.</li>
            <li>Blasio A, Steardo L, Sabino V, Cottone P. Addict Biol. 2014;19(4):652-662.</li>
            ...
            <li>Pike KM, Wilfley D, Hilbert A, Fairburn CG, Dohm FA, Striegel-Moore RH. Psychiatry Res. 2006;142(1):19-29. 14. Mitchell KS, Mazzeo SE, Schlesinger MR, Brewerton TD, Smith BN. Int J Eat Disord. 2012;45(3):307-315.</li>
          </ol>
        </div>
      </section>
    ...
    <script src="/hcp/js/vendor.js?1437594960397"></script>
    <script src="/hcp/js/templates.js?1437594960397"></script>
    <script src="/hcp/js/app.js?1437594960397"></script>
