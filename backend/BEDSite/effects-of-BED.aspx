<%@ Page Language="C#" AutoEventWireup="true" CodeFile="effects-of-BED.aspx.cs" Inherits="effects_of_BED" %>
...
<html lang="en" xmlns:ng="http://angularjs.org" id="ng-app" ng-app="cdmp" ng-controller="MainController" class="in-dev">
  <head>
    ...
    <link rel="stylesheet" href="/hcp/css/styles.css?1437594960055"/>
    <script src="//fast.fonts.net/jsapi/632e2bdc-4739-4b24-904b-c0e880eac200.js"></script>
    <script src="js/inline/cloak.js?__inline=true"></script>
    <script src="js/inline/iev.js?__inline=true"></script>
    <script src="/hcp/js/head.js?1437594960055"></script>
  </head>
  <body ontouchstart="" prime-directive="" class="effects-of-bed">
        ...
        <div class="wrap--content">
          ...
          <div class="charts">
            ...
            <div class="chart nineteen">
              ...
              <div class="text">reported <em>severe</em><br>impairment during the<br>past year</div>
            </div>
          </div>
          <h2 class="heading--2">
    ...
    <script src="/hcp/js/vendor.js?1437594960057"></script>
    <script src="/hcp/js/templates.js?1437594960057"></script>
    <script src="/hcp/js/app.js?1437594960057"></script>
