<%@ Page Language="C#" AutoEventWireup="true" CodeFile="identifying-patients.aspx.cs" Inherits="identifyingpatients" %><!DOCTYPE html>
    ...
    <main class="content--main">
      ...
      <section class="section--patients">
        <div class="wrap--content">
          ...
          <div class="persons"><a href="profiles.aspx#kimberly" class="person kimberly"></a><a href="profiles.aspx#nikki" class="person nikki"></a><a href="profiles.aspx#julie" class="person julie"></a><a href="profiles.aspx#diego" class="person diego"></a></div>
          <div class="callouts">
