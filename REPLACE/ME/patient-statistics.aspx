<%@ Page Language="C#" AutoEventWireup="true" CodeFile="patient-statistics.aspx.cs" Inherits="patientstatistics" %><!DOCTYPE html>
  ...
  <body ontouchstart="" prime-directive="" class="patient-statistics">
    <main class="content--main">
          ...
          <div class="wrap--content">
            <nav>
              <ul>
                ...
                <li><a href="/hcp/patient-statistics.aspx" class="active">Patient Demographics</a>
                </li>
      ...
      <section class="section--us">
        <div class="wrap--content">
          <h1 class="heading--1">Binge eating disorder (<abbr title="Binge Eating Disorder">B.E.D.</abbr>) is the most common<br class="desktop-break">eating disorder among US adults*<sup>1</sup></h1>
          ...
          <div class="statistics">
            <div class="map">
              ...
              <div class="stat">US adults have <abbr title="Binge Eating Disorder">B.E.D.</abbr><sup>&dagger;1-3</sup>
                
                
              </div>
            </div>
          </div>
          <p data-note="" class="footnote">*Estimated 12-month and lifetime prevalence among an eating disorder&ndash;assessed subsample <br>(n=2,980) of the National Comorbidity Survey Replication, a nationally representative face-to-face <br>household survey of English-speaking adults aged &ge;18 years.</p>
          <p data-note="" class="footnote">&dagger; Estimated 12-month prevalence in National Comorbidity Survey Replication of US adults aged &ge;18 <br>years, extrapolated to full US population aged &ge;18 years.<sup>1-3</sup>
      ...
      <section class="section--survey">
        <div class="wrap--content">
          ...
          <h2 class="heading--2">of the 344 who met DSM-5<sup>&reg;</sup> diagnostic criteria for <abbr title="Binge Eating Disorder">B.E.D.</abbr> in the past 12 months (level of severity not specified):
      ...
      <section class="section--ratio">
        <div class="wrap--content">
          <div class="row two-to-one">
            ...
            <div class="center">
              <h2 class="heading--2">
                <div class="estimated"><em class="ratio">2:1</em> Estimated 12-month prevalence of <span class="yellow"><abbr title="Binge Eating Disorder">B.E.D.</abbr></span> in US adults:</div>
          ...
          <div class="row five-to-one">
            <div class="center">
              <h2 class="heading--2">
                <div class="estimated"><em class="ratio">5:1</em> Estimated 12-month <br class="hide--lg hide--md">prevalence of <span class="yellow">bulimia nervosa</span> in US adults:</div>
          ...
          <p data-note-sup="" class="footnote">&sect;Data from an eating disorder&ndash;assessed subsample (n=2,980) of the National Comorbidity Survey Replication, a <br>nationally representative face-to-face household survey of English-speaking adults aged &ge;18 and older.<sup>1</sup>
      ...
      <section class="section--onset">
        <div class="wrap--content">
          <h1 class="heading--1">Onset of <abbr title="Binge Eating Disorder">B.E.D.</abbr> occurs at a later median age (21 years) than bulimia nervosa (18 years) and anorexia nervosa (18 years)<sup>||1</sup>
            
          </h1>
          <p data-note-sup="" class="footnote"><sup>||</sup>Data from an eating disorder&ndash;assessed subsample (n=2,980) of the National Comorbidity Survey Replication, a <br>nationally representative face-to-face household survey of English-speaking adults aged &ge;18 and older.<sup>1</sup>
      ...
      <section class="section--groups">
        <div class="wrap--content">
          ...
          <p data-note-sup="" class="footnote"><sup>&para;</sup>Sample from a combined data set of 3 nationally representative US samples.<sup>6</sup>
        ...
        <div class="wrap--refs">
          <ol class="refs number">
            ...
            <li>Kessler RC, Berglund PA, Chiu WT, et al. Biol Psychiatry. 2013;73(9):904-914.</li>
            <li>Howden LM, Meyer JA. Age and sex composition: 2010. US Census Bureau; 2011.</li>
            <li>Cossrow N, Russo LJ, Ming EE, et al. Poster presented at: APA 167th Annual Meeting; May 3-7, 2014; New York, NY.</li>
            ...
            <li>Marques L, Alegria M, Becker AE, et al. Int J Eat Disord. 2011;44(5):412-420.</li>
          </ol>
        </div>
      </section>
